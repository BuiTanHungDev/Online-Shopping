...
class CheckoutController extends Controller
{
    ...
    public function checkoutStore(Request $request)
    {
        ...
        $orderTotalAmount = floatval(Session::get('checkout')['sub_total']);
        $orderDeliveryCharge = floatval(Session::get('checkout')[0]['delivery_charge']);
        $orderCoupon = floatval($order['coupon']);

        $order['total_amount'] = $orderTotalAmount + $orderDeliveryCharge - $orderCoupon;

        // $order['total_amount'] = Session::get('checkout')['total_amount'] + Session::get('checkout')['0']['delivery_charge'] - $order['coupon'];
        ...
        $order['first_name'] = Session::get('checkout')['last_name'];
        ...
        $order['sstate'] = Session::get('checkout')['state'];
