...
class ShippingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('shipping.index')->with('success', 'Successfully created');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($shipping) {
            ...
            if ($status) {
                return redirect()->route('shipping.index')->with('success', 'Successfully updated banner');
            } else {
    ...
    public function destroy($id)
    {
        ...
        if ($shipping) {
            ...
            if($status){
                return redirect()->route('shipping.index')->with('success',"Banner successfully deleted");
            }
            else
            {
                return back()->with('error','Something went wrong! ');
