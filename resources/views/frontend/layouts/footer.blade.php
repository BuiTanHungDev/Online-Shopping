            ...
            <div class="col-12 col-sm-6 col-md-5 col-lg-4 col-xl-3">
                <div class="single_footer_area mb-100">
                    ...
                    <div class="footer_social_area mt-15">
                        <a href="{{\App\Models\Settings::value('facebook_url')}}"><i class="fa-brands fa-facebook" aria-hidden="true"></i> </a>
                        <a href="{{\App\Models\Settings::value('twitter_url')}}"><i class="fa-brands fa-twitter"aria-hidden="true"></i></a>
                        <a href="{{\App\Models\Settings::value('instagram_url')}}"><i class="fa-brands  fa-instagram" aria-hidden="true"></i></a>
                        <a href="{{\App\Models\Settings::value('google_url')}}"><i class="fa-brands  fa-google" aria-hidden="true"></i></a>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6">
                    <div class="copywrite_text">
                        <p>Made with <i class="fa fa-heart" aria-hidden="true"></i><a href="#">
