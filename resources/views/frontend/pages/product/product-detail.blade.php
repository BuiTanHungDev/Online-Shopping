                                    ...
                                    <form class="cart" method="post">
                                        <div class="quantity">
                                            <input data-id="{{ $product->id }}" type="number"
                                                class="qty-text form-control" id="qty2" step="1" min="1"
                                                max="12" name="quantity" value="1">
                                        </div>
                                        <button type="submit"name="addtocart"
                                            id="add_to_cart_button_details_{{ $product->id }}"
                                            data-product_id="{{ $product->id }}" data-quantity="1"
                                            data-price="{{ $product->offer_price }}" value="5"
                                            class="cart-submit add_to_cart_button_details">
                                            Add to cart
                                        </button>
                                        <!-- Wishlist -->
                ...
                <div class="col-12 col-lg-6">
                    <div class="single_product_desc">
                        ...
                        <div class="widget p-0 size mb-3">
                            ...
                            <div class="widget-desc" style="width: 50%">
                                @php
                                    $sizes = \App\Models\ProductAttribute::where('product_id', $product->id)->get();
                                @endphp
                                <select name="size" id="size">
                                    @foreach ($sizes as $sg)
                                        <option value="{{ $sg->size }}">{{ $sg->size }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <form class="cart clearfix my-5 d-flex flex-wrap align-items-center">
                            ...
                            <div class="quantity">
                                <input type="number" data-id="{{ $product->id }}" class="qty-text form-control"
                                    id="qty2" step="1" min="1" max="12" name="quantity"
                                    value="1">
                            </div>
                            <button href="javascipt:void(0);" type="button" name="addtocart" value="5"
                                data-product_id="{{ $product->id }}" data-quantity="1"
                                data-price="{{ $product->offer_price }}"
                                id="add_to_cart_button_details_{{ $product->id }}"data-size="{{ $product->size }}"
                        ...
                        <div class="others_info_area mb-3 d-flex flex-wrap">
                            <a class="add_to_wishlist" id="add_to_wishlist{{ $product->id }}" class="add_to_wishlist"
                                data-quantity="1" data-id="{{ $product->id }}"><i class="fa fa-heart"
                                ...
                                <div class="submit_a_review_area mt-50">
                                    ...
                                    @else
                                        <p class="py-5">You need to login for writing review ! <a
                                                href="{{ route('user.auth') }}">Login</a> </p>
                                    ...
                                    <div class="single-product-area">
                                        ...
                                        <div class="product_description">
                                            ...
                                            <div class="product_add_to_cart">
                                                <a href="javascipt:void(0);" class="add_to_cart" data-quantity="1"
                                            ...
                                            <h6 class="product-price">${{ number_format($item->offer_price, 2) }}
                                                <small><del class="text-danger">${{ number_format($item->price) }}</del>
                                                </small>
                                            </h6>
                                        </div>
                                    </div>
