                                ...
                                <div class="col-12 col-lg-7">
                                    ...
                                    <form class="cart" method="post">
                                        ...
                                        <div class="modal_pro_wishlist">
                                            <a href="{{ route('wishlist.store') }}"><i class="icofont-heart"></i></a>
                                        </div>
                                        <!-- Compare -->
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="shop_top_sidebar_area d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <select id="sortBy" class="small right" name="sortBy">
                            ...
                            <option value="titleDesc"{{ old('sortBy') == 'titleDesc' ? 'selected' : '' }}>Alphabetical
                                Descending</option>
                            <option value="discountAsc"{{ old('sortBy') == 'discountAsc' ? 'selected' : '' }}>Discount -
                                Lower To Higher</option>
                            <option value="discountDesc"{{ old('sortBy') == 'discountDesc' ? 'selected' : '' }}>Discount -
                    ...
                    <div class="shop_grid_product_area">
                        ...
                        <div class="ajax-load text-center" style="display: none">
                            <img src="{{ asset('frontend/img/loader.gif') }}" style="width: 10%;" alt="">
                        </div>
                    </div>
                </div>
    </section>
    ...
    <script>
        $(document).ready(function() {
            function loadmoreData(page) {
                var sort = $('#sortBy').val();
                $.ajax({
                        url: window.location.href + '?sort=' + sort + '&page=' + page,
                        type: 'GET',
                        beforeSend: function() {
                            $('.ajax-load').show();
                        },
            ...
            $(window).scroll(function() {
                if (!isLoading && $(window).scrollTop() + $(window).height() + 120 >= $(document)
                    .height()) {
                    page++;
                    isLoading = true;
                    loadmoreData(page);
