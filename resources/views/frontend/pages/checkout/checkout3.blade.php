...
<div class="checkout_steps_area">
    <a class="complated" href="#"><i class="icofont-check-circled"></i> Login</a>
                                ...
                                <div class="panel-heading" role="tab" id="five">
                                    <h6 class="panel-title">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <label class="custom-control-label" for="customCheck2"> <i class="icofont-credit-card"></i>Credit or Debit Card</label>
                                        </div>
